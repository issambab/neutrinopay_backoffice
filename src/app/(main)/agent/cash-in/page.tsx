...
import { BanknoteArrowUp, CheckCircle2, Clock3, HandCoins, Landmark, WalletCards } from "lucide-react";
...
export default async function AgentCashInPage({ searchParams }: AgentCashInPageProps) {
  ...
  try {
    const [profile, floatBalance, earningsBalance, cashInOperations] = await Promise.all([
      getCurrentAgentProfile(),
      getCurrentAgentFloatBalance(),
      getCurrentAgentEarningsBalance(),
          ...
          <div className="grid gap-5 border-b bg-muted/20 p-5 lg:grid-cols-[minmax(0,1fr)_22rem] lg:p-6">
            <div className="min-w-0">
              ...
              <p className="mt-1 max-w-2xl text-muted-foreground text-sm">
                Saisissez le montant brut recu en cash, confirmez l'OTP client, puis postez l'operation dans Formance.
              </p>
            </div>
          ...
          <div className="grid gap-4 p-4 lg:grid-cols-[minmax(0,1fr)_24rem] lg:p-5">
            ...
            <div className="grid content-start gap-3">
              ...
              <MetricCard
                ...
                label="Brut encaisse"
                value={formatMinorAmount(metrics.grossMinor)}
                helper="Cash-in postes, avant commission"
              />
              <MetricCard
                icon={HandCoins}
