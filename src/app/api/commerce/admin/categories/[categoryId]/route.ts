...
import { deleteAdminProductCategory, updateAdminProductCategory } from "@/lib/commerce/commerce.server";
...
export async function PATCH(request: Request, context: RouteContext) {
  ...
  try {
    const category = await updateAdminProductCategory(categoryId, body);
